...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Split FASTA files on 'N's and generate new files in train/val/test directories.")
    
    # Accepting a list of FASTA files and an output directory
    parser.add_argument('fasta_files', nargs='+', help="List of FASTA files to process (should contain 'train', 'val', or 'test' in the filename)")
    parser.add_argument('--output_dir', required=True, help="Base directory to save processed files in train/val/test directories")
