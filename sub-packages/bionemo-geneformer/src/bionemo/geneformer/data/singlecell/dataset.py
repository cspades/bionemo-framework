...
class SingleCellDataset(SingleCellMemMapDataset):
    ...
    def __init__(  # noqa: D107
        ...
        super().__init__(str(data_path), feature_list=["feature_id"])
    ...
    def __getitem__(self, index: EpochIndex) -> types.BertSample:
        ...
        values, feature_ids = self.get_row(index.idx, return_features=True, feature_vars=["feature_id"])
        assert (
            len(feature_ids) == 1
